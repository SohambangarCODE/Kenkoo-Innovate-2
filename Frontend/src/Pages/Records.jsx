  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-50 py-6 px-4 md:py-8 md:px-8">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Health Records</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {records.map((record, index) => (
            <div key={index} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <button className="mt-4 w-full py-2 rounded-xl border border-gray-200 text-sm font-semibold text-gray-600 hover:bg-gray-50 transition-colors">
                View Details
              </button>
            </div>
          ))}
          ...
          <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-5 flex flex-col items-center justify-center text-center hover:bg-blue-50/50 hover:border-blue-200 transition-colors cursor-pointer group h-full min-h-[180px]">
