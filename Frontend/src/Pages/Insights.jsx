    ...
    <div className="h-full overflow-y-auto bg-gray-50 py-4 px-3 sm:py-6 sm:px-4 md:py-8 md:px-8">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-2xl md:text-3xl font-bold text-gray-800">Health Insights</h1>
          <p className="text-gray-500 mt-1 text-sm md:text-base">AI-powered analysis of your health data.</p>
        </div>

        {/* Featured Insight */}
        <div className="bg-gradient-to-r from-[#1447E6] to-[#3C53E8] rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 text-white shadow-xl mb-6 sm:mb-8 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none"></div>
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full bg-white/20 backdrop-blur-sm text-xs font-semibold mb-3 sm:mb-4 border border-white/10">
              <i className="ri-sparkling-fill text-yellow-300"></i> Daily Tip
            </div>
            <h2 className="text-xl sm:text-xl md:text-2xl font-bold mb-2">Hydration matters!</h2>
