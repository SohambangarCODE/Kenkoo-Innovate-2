...
const Assistant = () => {
  ...
  const analyzeFile = async () => {
    ...
    try {
      ...
      const data = await res.json();
      const result = data?.result || "File processed.";
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 md:px-6">
        <div className="max-w-3xl mx-auto space-y-6 pb-6">
          ...
          {messages.map((msg, idx) => (
            ...
            >
              <div
                className={`max-w-[86%] md:max-w-[78%] px-4 py-3 rounded-2xl text-[15px] leading-relaxed whitespace-pre-wrap break-words shadow-sm ${
                  msg.role === "user"
              ...
              >
                ...
                {/* Optional: Regenerate button under assistant messages */}
                {msg.role === "assistant" &&
                  ...
                  !isLoading && (
                    <button
                      ...
                      onClick={() => {
                        ...
                        alert("Regenerate not implemented yet");
                      }}
                    >
                      Regenerate
                    </button>
            ...
            <div className="flex items-center gap-1.5 pr-2">
              {file ? (
                <button
                  onClick={analyzeFile}
                  disabled={isLoading}
                  className="px-4 py-2.5 bg-[#0f62fe] hover:bg-blue-700 text-white text-sm font-medium rounded-xl disabled:opacity-60 transition-colors shadow-sm"
                >
                  Analyze
                </button>
              ) : (
